...
if(isset($_POST['order'])){
    ...
    $address = mysqli_real_escape_string($conn, 'street- '. $_POST['street'].', '. $_POST['country']);
...
<section class="checkout">
    ...
    <form id="checkout-form"action="" method="POST">
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                <span>City :</span>
                <input type="text" name="country" placeholder="e.g. kathmandu">
            </div>
        </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    paymentButton.addEventListener('click', function(event) {
        ...
        if (form.checkValidity()) {
            ...
            // Khalti configuration options
            var config = {
                publicKey: 'your_public_key', // Replace 'your_public_key' with your actual public key
                productIdentity: '1234567890',
                productName: 'Your Product Name',
                productUrl: 'https://yourproducturl.com',
                eventHandler: {
                    onSuccess(payload) {
                        console.log(payload);
                    },
            ...
            checkout.show({amount: 2000}); // Amount should be dynamically set based on your requirement
        } else {
